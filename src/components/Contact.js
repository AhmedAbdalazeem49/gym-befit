            ...
            <div className="row">
              <div className="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
                <div className="fh5co-intro fh5co-table-cell animate-box">
                  ...
                  <p>
                    Ready to take the next step towards your fitness goals?
            ...
            <form action="#">
              <div className="row">
                <div className="col-md-6 animate-box">
                  ...
                  <p>
                    Visit our vibrant fitness hub today for expert guidance and
                    support on your wellness journey
                  </p>
                  <ul className="contact-info">
                    <li>
                      <i className="icon-location-pin"></i>ElDakhaliya -
                      Mansoura - Talkha - MeetElkorma
                    </li>
                    <li>
                      <i className="icon-phone2"></i>+20 101 373 3943
                    </li>
                  </ul>
                </div>
                <div className="col-md-6 animate-box">
